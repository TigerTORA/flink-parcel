...
CM_EXT_BRANCH=cm5-5.16.1
FLINK_URL=http://mirrors.tuna.tsinghua.edu.cn/apache/flink/flink-1.7.2/flink-1.7.2-bin-hadoop26-scala_2.12.tgz 
...
flink_parcel_name="$flink_parcel_folder-el7.parcel"
...
function build_flink_parcel {
  ...
  sha1sum ./$flink_built_folder/$flink_parcel_name > ./$flink_built_folder/$flink_parcel_name.sha
}
